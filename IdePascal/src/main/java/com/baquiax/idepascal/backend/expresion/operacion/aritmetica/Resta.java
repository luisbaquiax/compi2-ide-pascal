...
public class Resta extends Sentencia {

    private Sentencia operandoIzq;
    private Sentencia operandoDer;

    public Resta(Sentencia operandoIzq, Sentencia operandoDer,int line, int col) {
    ...
    private Object getResult(Object izquierdo, Object derecho){
        ...
        switch (izq){
                ...
                switch (der){
                    ...
                    default -> {
                        return new ErrorPascal(
                                ...
                                "aritmética-resta: Expresion no válida, se esperaba un ENTERO o REAL.",
            ...
            default -> {
                return new ErrorPascal(
                        TipoError.SEMANTICO.name(),
                        "aritmética-resta: Expresion no válida, se espera un ENTERO o REAL",
