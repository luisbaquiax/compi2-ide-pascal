...
public class Mayor extends Sentencia {

    private Sentencia operandoDer;
    private Sentencia operandoIzq;

    public Mayor(Sentencia operandoIzq, Sentencia operandoDer, int line, int col) {
                ...
                switch (tipoDer){
                    ...
                    default -> {
                        return new ErrorPascal(
                                ...
                                "relacional-mayor: Error semántico, expresión inválida. Se esperaba un ENTERO o REAL.",
            ...
            case CARACTER, CADENA -> {
                switch (tipoDer){
                    ...
                    default -> {
                        return new ErrorPascal(
                                TipoError.SEMANTICO.name(),
                                "relacional-mayor: Error semántico, expresión inválida. Se esperaba un CARACTER.",
                                this.operandoDer.line, this.operandoDer.col);
                    }
                }
            }
            case BOOLEAN -> {
                ...
                switch (tipoDer){
                    ...
                    default -> {
                        return new ErrorPascal(
                                TipoError.SEMANTICO.name(),
                                "relacional-mayor: Error semántico, expresión inválida.",
