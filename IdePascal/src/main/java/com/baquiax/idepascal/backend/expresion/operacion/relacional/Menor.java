...
public class Menor extends Sentencia {

    private Sentencia operandoDer;
    private Sentencia operandoIzq;

    public Menor(Sentencia operandoIzq, Sentencia operandoDer, int line, int col) {
                ...
                switch (tipoDer){
                    ...
                    default -> {
                        return new ErrorPascal(
                                ...
                                "relacional-menor: Error semántico, expresión inválida. Se esperaba un ENTERO o REAL.",
            ...
            case CARACTER, CADENA -> {
                switch (tipoDer){
                    ...
                    default -> {
                        return new ErrorPascal(
                                TipoError.SEMANTICO.name(),
                                "relacional-menor: Error semántico, expresión inválida. Se esperaba un CARACTER.",
                                this.operandoDer.line, this.operandoDer.col);
                    }
                }
            }
            case BOOLEAN -> {
                ...
                switch (tipoDer){
                    ...
                    default -> {
                        return new ErrorPascal(
                                TipoError.SEMANTICO.name(),
                                "relacional-menor: Error semántico, expresión inválida.",
